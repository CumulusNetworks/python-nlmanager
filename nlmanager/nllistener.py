#!/usr/bin/env python
#
# Copyright (C) 2015-2019 Cumulus Networks, Inc. all rights reserved
#
            ...
            for s in readable:
                ...
                while data:
                    ...
                    if msgtype == NLMSG_DONE:
                        ...
                        if error_code:
                            try:
                                error_string = os.strerror(error_code)
                            except:
                                error_string = msg.error_to_string.get(error_code)
                            log.debug("%s %s: RXed NLMSG_ERROR code %s (%d)" % (self, socket_string[s], error_string, error_code))
